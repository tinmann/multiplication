...
import microservices.book.multiplication.challenge.ChallangeSolvedDto;
...
public class GamificationServiceClient {
    ...
    public boolean sendAttempt(final ChallengeAttempt attempt) {
        try {
            ChallangeSolvedDto dto = new ChallangeSolvedDto(attempt.getId(), attempt.isCorrect(), attempt.getFactorA(),
